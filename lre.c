...
static int lrc_call_register(struct keyword_stub *parent,
                             struct lrc_stub_call *call)
{
    int i;
...
static int lrc_func_register(struct keyword_stub *parent,
                             struct lrc_stub_func *func)
{
    int i;
    struct keyword_stub *kstub;
    struct keyword_stub *substub;
